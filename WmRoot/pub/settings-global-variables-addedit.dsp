...
input[type='password'] { display: block; width: 100% }
  ...
  <script language="JavaScript">
	function validate(thisform,oper)
    {
	    if(oper == 'edit')
        {
           if (255 < thisform.value.value.length) {
            ...
            <form name="htmlform_glConfig" action="settings-global-variables.dsp" method="POST">
                ...
                <input type="hidden" name="operation">
                        <table class="tableView width25">
                            ...
                            <tr>
                                <td class="oddrow"><label for="packageName">Package</label></td>
                                <td class="oddrow-l">
                                    %ifvar operation equals('add')%
                                    ...
                                    %endif%
                                    %ifvar operation equals('edit')%
                                        <input type="text" size="40" name="packageName" id="packageName" value="%value packageName encode(htmlattr)%" readonly="true" style="border:0;">
                                    %endif%
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="evenrow-l" >
                                    ...
                                    %endif% 
                                    %ifvar operation equals('edit')%
										<input type="text" size="40" name="key" id="key" value="%value key encode(htmlattr)%" readonly="true" style="border:0;">
                                    %endif%
                                </td>
                            </tr>
                            <tr>
